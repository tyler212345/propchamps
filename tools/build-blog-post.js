...
const CONFIG = {
  ...
  'do-prop-firms-actually-pay': { eyebrow: 'Prop firm data · Trust', tag: 'Data',
    related: [['/payouts','Live payout data'],['/blog/how-prop-firm-payouts-work','How payouts work'],['/compare','Compare every firm']] },
...
<footer class="site">
  <div class="container">
    <div class="top">
      ...
      <div><h4>Research</h4><ul><li><a href="/">All firms</a></li><li><a href="/compare">Compare</a></li><li><a href="/deals">Active deals</a></li><li><a href="/payouts">Payouts</a></li><li><a href="/audit-log">Audit log</a></li><li><a href="/rewards">Rewards</a></li></ul></div>
